...
- 💬 I speak `zh-cn` (native) & `en`. Self-learning `jp` currently, might take class on basic `yue` next year and I really want to learn `fr` & `latin` 😔 (actually did learn *a tiiiiiny bit* on Duolingo but still 😢)
